...
/// Страница с описанием товара : 2866763, Источник питания QUINT-PS/1AC/24DC/10
...
<head>
    ...
    <meta name="description" content="Страница с описанием Источника питания QUINT-PS/1AC/24DC/10 с артикулом производителя 2866763">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">1.10 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Упаковка (В х Ш х Д)</div>
                                    <div class="characteristic-type__siscr">60 х 130 х 125 мм</div>
                                </li>
                            </ul>
                        </div>
