...
/// Страница с описанием товара : XB5AVM3, SE XB5 Лампа сигнальная зелёная светодиодная 230В, Schneider Electric, XB5AVM3
...
<head>
    ...
    <meta name="description" content="Страница с описанием товара : XB5AVM3, SE XB5 Лампа сигнальная зелёная светодиодная 230В, Schneider Electric">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">Harmony</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Диаметр отверстия</div>
                                    <div class="characteristic-type__siscr">22.5 мм</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Цвет линзы</div>
                                    <div class="characteristic-type__siscr">Зеленый</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Тип линзы</div>
                                    <div class="characteristic-type__siscr">плоская</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Тип цоколя лампы</div>
                                    <div class="characteristic-type__siscr">Светодиод. (LED)</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Номин. раб. напряжение Ue</div>
                                    <div class="characteristic-type__siscr">230.0...240.0</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Количество световых индикаторов</div>
                                    <div class="characteristic-type__siscr">1</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Масса нетто</div>
                                    <div class="characteristic-type__siscr">0.048 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Упаковка (В х Ш х Д)</div>
                                    <div class="characteristic-type__siscr">42 х 30 х 54 мм</div>
                                </li>
                            </ul>
                        </div>
