...
/// Страница с описанием товара : 1SFA898116R7000, Софтстартер PSTX470-600-70 250кВт 400В 470A (450кВт 400В 814A внутри треугольника) с функцией защиты двигателя
/// Подключиться к базе данных, достать необходимую по арткулу информацию и заполнить страницу
...
<head>
    ...
    <meta name="description" content="Страница с описанием товара : 1SFA898116R7000, Софтстартер PSTX470-600-70 250кВт 400В 470A (450кВт 400В 814A внутри треугольника) с функцией защиты двигателя">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">Пускорегулирующая аппаратура</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Номинальная мощность электродвигателя, КВт</div>
                                    <div class="characteristic-type__siscr">250</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Количество фаз</div>
                                    <div class="characteristic-type__siscr">3</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Напряжение</div>
                                    <div class="characteristic-type__siscr">380 В</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Номинальный ток</div>
                                    <div class="characteristic-type__siscr">470 А В</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Наличие интерфейса связи</div>
                                    <div class="characteristic-type__siscr">MODBUS RTU</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Масса нетто</div>
                                    <div class="characteristic-type__siscr">25 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Упаковка (В х Ш х Д)</div>
                                    <div class="characteristic-type__siscr">380 х 650 х 480 мм</div>
                                </li>
                            </ul>
                        </div>
                        <div class="discription-product__bascket-block">
                            <img src="https://shop.encomponent.ru/img/abb_logo.jpg" alt="Логотип Schneider Electric" class="img-brend">
