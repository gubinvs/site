    ...
    <div class='container' id='technical'>
        ...
        <table class='table table-bordered table-striped mt-3'>
            ...
            <tbody>
                ...
                <tr>
                    <td>Номинальное напряжение сети</td>
                    <td>380/220;660/380</td>
                </tr>
                <tr>
                    <td>Наличие теплового расцепителя</td>
                    <td>false</td>
                </tr>
                <tr>
                    <td>Наличие электромагнитного расцепителя</td>
                    <td>true</td>
                </tr>
                <tr>
                    <td>Наличие электронного расцепителя</td>
                    <td>false</td>
                </tr>
                <tr>
                    <td>Наличие дифференциального расцепителя</td>
                    <td>false</td>
                </tr>
                <tr>
                    <td>Электродинамическая стойкость при 380/220В Icm</td>
                    <td>17</td>
                </tr>
                <tr>
                    <td>Предельная коммутационная способность при 660/380В Ics</td>
                    <td>7.5</td>
                </tr>
                <tr>
                    <td>Электродинамическая стойкость при 660/380В Icm</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Токи уставки расцепителя в зоне перегрузки Ir, А</td>
                    <td>0,6</td>
                </tr>
                <tr>
                    <td>Кратность тока для времени tr, о.е.</td>
                    <td>6</td>
                </tr>
                <tr>
                    <td>Кратность нижней границы, о.е.</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Кратность верхней границы, о.е.</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Коэффициент гарантированного несрабатывания, о.е.</td>
                    <td>1</td>
                </tr>
                <tr>
                    <td>Коэффициент гарантированного срабатывания, о.е.</td>
                    <td>1</td>
                </tr>
                <tr>
                    <td>Время срабатывания расцепителя в зоне КЗ tm</td>
                    <td>0.1</td>
                </tr>
                <tr>
                    <td>Кратности уставки мгновенного расцепителя Ki, о.е.</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Время срабатывания мгновенного расцепителя ti</td>
                    <td>0.05</td>
                </tr>
                <tr>
                    <td>Токи уставок I∆, мА</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Активное сопротивление полюса R, мОм</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Реактивное сопротивление полюса X, мОм</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Высота</td>
                ...
                <tr>
                    <td>Тип монтажной рейки</td>
                    <td>35х7.5; 35х15</td>
                </tr>
                <tr>
                    <td>Крепление</td>
                    <td>Монтажная рейка</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Время срабатывания в зоне перегрузки tr, c</td>
                    <td>12</td>
                </tr>
                <tr>
                    <td>Способ задания уставки расцепителя</td>
                    <td>По кратности (Km)</td>
                </tr>
                <tr>
                    <td>Кратности уставки расцепителя Кm, о.е</td>
                    <td>12</td>
                </tr>
                <tr>
                    <td>Способ задания уставки мгновенного расцепителя</td>
                    <td>По току (Ii)</td>
                </tr>
                <tr>
                    <td>Тип характеристики срабатывания расцепителя Tm</td>
                    <td>B</td>
                </tr>
                <tr>
                    <td>Нормативный документ</td>
                    <td>ГОСТ Р 50030.2, ТУ16-90 ИКЖШ.641211.002ТУ</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Токи уставки мгновенного расцепителя Ii, о.е.</td>
                    <td>Нет (без)</td>
                </tr>
                <tr>
                    <td>Максимальное сечение проводника, мм^2</td>
                    <td>25</td>
                </tr>
                <tr>
                    <td>Токи уставки расцепителя Im, А</td>
                    <td>Нет (без)</td>
                </tr>
                <tr>
                    <td>Номинальный продолжительный ток Iu</td>
                    <td>0.6</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Рычажковый (перекидной рычаг)</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Тип подключения силовой электрической цепи</td>
                    <td>Винтовое соединение</td>
                </tr>
                <tr>
                    <td>Количество вспомогательных нормально замкнутых (НЗ) контактов</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Количество вспомогательных нормально разомкнутых (НО) контактов</td>
                    <td>0</td>
                </tr>
                <tr>
                    <td>Тип изделия/компонента</td>
                    <td>Выключатель автоматический в литом корпусе</td>
                </tr>
                <tr>
                    <td>Конструкция прибора</td>
                    <td>Встраиваемое устройство фиксированной установки (стационарный)</td>
                </tr>
                <tr>
                    <td>Диапазон регулировки теплового расцепителя</td>
                    <td>0.6...0.6</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Подходит для монтажа на DIN-рейку (Ω-типа)</td>
                    <td>false</td>
                </tr>
                <tr>
                    <td>Номинальная отключающая способность Icu при 400 В, 50 Гц</td>
                    <td>10</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Вид подключения главной электрической цепи</td>
                    <td>Подключение спереди</td>
                </tr>
                <tr>
                    <td>Количество вспомогательных переключающих контактов</td>
                    <td>0</td>
                </tr>
                <tr>
        ...
        <h3 class='mt-4'>Файлы и документы</h3>
        <ul>
            ...
            <div class="please-note-section__card-product">
                ...
                function formatRub($price)
                {
                    if (!class_exists('NumberFormatter')) {
                        // fallback если intl не доступен
                ...
                // fallback для изображений (подставьте реальный путь)
                ...
                if (is_array($data) && count($data) > 0) {
                    foreach ($data as $item) {
                        ...
                        // подготовка отображаемой цены ДО вывода
                        $fmtPrice = htmlspecialchars(formatRub($price), ENT_QUOTES, 'UTF-8');

                        // класс для наличия
                        $qtyClass = $quantity === 0 ? 'delivry-block__quantity delivry-block__quantity_0' : 'delivry-block__quantity';
                        $qtyText = $quantity === 0 ? 'Под заказ' : "Наличие: {$quantity} шт.";
