<?php /// Размеры картинок _big_1920.jpg - h=340px; _icon-card.jpg = h=150px; _basket_icon.jpg - h = 88px;   
/// Страница с описанием товара : TM241CE24T, Контроллер M241-24IO транзисторный источник ETHERNET

// Переменные для заполнения страницы данными
$vendorСode = 'TM241CE24T';
...
<head>
    ...
    <meta name="description" content="Страница с описанием товара : TM241CE24T, Контроллер M241-24IO транзисторный источник ETHERNET">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">Блок базовый</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Возможность монтажа на рейку</div>
                                    <div class="characteristic-type__siscr">да</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Тип напряжения</div>
                                    <div class="characteristic-type__siscr">DC (пост.)</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Поддержка протокола MODBUS</div>
                                    <div class="characteristic-type__siscr">да</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Поддержка протокола TCP/IP</div>
                                    <div class="characteristic-type__siscr">да</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Количество HW-интерфейсов RS-232</div>
                                    <div class="characteristic-type__siscr">2</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Количество HW-интерфейсов RS-485</div>
                                    <div class="characteristic-type__siscr">2</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Количество цифров. выходов</div>
                                    <div class="characteristic-type__siscr">10</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Количество цифров. входов</div>
                                    <div class="characteristic-type__siscr">14</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Масса нетто</div>
                                    <div class="characteristic-type__siscr">1.0 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Упаковка (В х Ш х Д)</div>
                                    <div class="characteristic-type__siscr">100 х 190 х 100 мм</div>
                                </li>
                            </ul>
                        </div>
