<div className="directory-groups__container">
        ...
        <div className="dg-card__groop">
            ...
            <div className="dg-card__groop">
                <div className="dg-card dg-card6 hvr-grow-shadow">
                    <div className="dg-card__title dg-card__title_dg-card5">Индикация</div>
                </div>
                <div className="dg-card dg-card7 hvr-grow-shadow">
