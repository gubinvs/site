...
/// Страница с описанием товара : 2903147,Источник питания TRIO-PS-2G/1AC/ 24DC/3/C2LPS
...
<head>
    ...
    <meta name="description" content="Страница с описанием товара : 2903147,Источник питания TRIO-PS-2G/1AC/ 24DC/3/C2LPS">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">3 А</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">72 Вт</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">1.5 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Упаковка (В х Ш х Д)</div>
                                    <div class="characteristic-type__siscr">140 х 50 х 160 мм</div>
                                </li>
                            </ul>
                        </div>
