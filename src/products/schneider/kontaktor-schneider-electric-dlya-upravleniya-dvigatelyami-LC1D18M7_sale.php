...
<head>
    ...
    <meta property='og:url' content='https://encomponent.ru/products/schneider/kontaktor-schneider-electric-dlya-upravleniya-dvigatelyami-LC1D18M7_sale.php'>
                    ...
                    <div class='attention-container'>
                      ...
                      <div class='attention-section__discription'>
                          Контактор LC1D18M7 Schneider Electric доступен к покупке со склада.
                            ...
                            Вы можете купить контактор 220В для управления электродвигателями, насосами, вентиляцией и промышленным оборудованием.

                            Преимущества покупки у нас:<br>

                            • Наличие на складе<br>
                            • Быстрая обработка заказа<br>
                            • Отгрузка по всей России<br>
                            • Официальная продукция Schneider Electric<br>

                            Оформите заказ онлайн или запросите счет у менеджера.
                        </div>
                    </div>
                </section>
            </div>
