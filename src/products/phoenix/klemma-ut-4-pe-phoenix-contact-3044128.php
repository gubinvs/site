...
<html lang='ru'>
    <head>
        <meta charset='UTF-8'>
        <title>3044128, Заземляющая DIN-клемма (UT 4-PE) - Phoenix Contact | Компоненты энергии</title>
        <meta name='description' content='Заземляющую клемму 3044128 UT 4-PE желто-зеленую от производителя Phoenix Contact можно купить на сайте Компоненты энергии. Продлагаем ее по цене:  <?php echo $price ?> RUB.'>
        <meta name='keywords' content='Клемма заземляющая UT 4-PE желто-зеленая - артикул 3044128'>
        <meta name='robots' content='index, follow'>
        <meta name='viewport' content='width=device-width, initial-scale=1.0'>
        <link rel='icon' href='https://encomponent.ru/favicon.svg' type='image/svg+xml'>
        <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css' rel='stylesheet'>
        <link rel='stylesheet' href='../../css/encomp-nku-project-style.css'>
        <link rel='canonical' href='https://encomponent.ru/products/phoenix/klemma-ut-4-pe-phoenix-contact-3044128.php'>
        <!--Open Graph-->
        <meta property='og:title' content='3044128, Заземляющая DIN-клемма (UT 4-PE) желто-зеленая - Phoenix Contact продается на сайте компоненты энергии, ее артикул 3044128'>
        <meta property='og:description' content='Клемму заземляющюю на DIN-рейку UT 4-PE желто-зеленую от производителя Phoenix Contact можно купить на сайте Компоненты энергии. Продлагаем ее по цене:  <?php echo $price ?> RUB.'>
        <meta property='og:image' content='https://encomponent.ru/img/img-product/3044128/phoenix_contact-3044128-image.png'>
        <meta property='og:type' content='product'>
        <meta property='og:url' content='https://encomponent.ru/products/phoenix/klemma-ut-4-pe-phoenix-contact-3044128.php'>
        <!-- JSON-LD Product schema -->
        <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "Product",
            "name": "3044128, Заземляющая DIN-клемма (UT 4-PE) - Phoenix Contact | Компоненты энергии",
            "image": "https://encomponent.ru/img/img-product/3044128/phoenix_contact-3044128-image.png",
            "description": "Заземляющая клемма модели 3044128 UT 4-PE желто-зеленая от производителя Phoenix Contact предлагается по цене: <?php echo $price; ?> RUB. В наличии: <?php echo $quantityBestseller; ?> шт.",
            "sku": "3044128",
            "brand": {
                "@type": "Brand",
            ...
            "offers": {
                ...
                "url": "https://encomponent.ru/products/phoenix/klemma-ut-4-pe-phoenix-contact-3044128.php",
                "inventoryLevel": {
...
<body>
    ...
    <main>
        <div class='discription-product-section'>
            <div class='container'>
                <h1 class='discription-product-section__title NKUPages_h1'>3044128, Заземляющая DIN-клемма (UT 4-PE) - Phoenix Contact</h1>
                <section class='main-section flex'>
                    <div class='main-section__img-block'>
                        <img src='https://encomponent.ru/img/img-product/3044128/phoenix_contact-3044128-image.png' alt='Изображена клемма на дин рейке, желто-зеленая UT 4-PE от Компонентов энергии' class='discription-product__img main-section__img'>
                    </div>
                    <div class='main-section__discription'>
                        <div class='article-block flex'>
                            <div class='article-title'>Артикул:</div>
                            <h6 class='article-name'>3044128</h6>
                        </div>
                        <hr>
                        ...
                        <div class='characteristics-block'>
                            <div class='characteristics-block__title'>Основные характеристики:</div>
                                <ul class='characteristics-block__list'>
                                    ...
                                    <li class='characteristics-block__item flex'>
                                        <div class='characteristics-item__title'>Тип клеммника:</div>
                                        <div class='characteristics-item__discr'>Заземляющий (PE) клеммник</div>
                                    </li>
                                    <li class='characteristics-block__item flex'>
                                    ...
                                    <li class='characteristics-block__item flex'>
                                        <div class='characteristics-item__title'>Номинальное напряжение, В:</div>
                                        <div class='characteristics-item__discr'>до 1000</div>
                                    </li>
                                    <li class='characteristics-block__item flex'>
                                        <div class='characteristics-item__title'>Тип монтажа:</div>
                                        <div class='characteristics-item__discr'>На DIN-рейку (NS 35)</div>
                                    </li>
                                    <li class='characteristics-block__item flex'>
                            ...
                            <div class='characteristics-block__button-block flex'>
                                ...
                                <a href='https://shop.encomponent.ru/Basket/?vendorCode=3044128'>
                ...
                <section class='attention-section'>
                    ...
                    <div class='container attention-container'>
                        ...
                        <div class='attention-section__discription'>
                            <b>3044128 UT 4-PE</b> — это компактный и надёжный заземляющий клеммник, предназначенный для быстрого и безопасного подключения защитного проводника на DIN-рейке. Корпус выполнен из прочного негорючего материала, а конструкция обеспечивает стабильный контакт с шиной и удобный монтаж даже в стеснённых условиях. Отличается высокой виброустойчивостью, низким переходным сопротивлением и совместимостью с широким спектром стандартных аксессуаров, что делает его оптимальным решением для распределительных шкафов и промышленных автоматизированных систем.
                        </div>
                    </div>
                </section>
            </div>
        ...
        <div class='container' id='technical'>
            ...
            <table class='table table-bordered table-striped mt-3'>
                ...
                <tbody>
                    <tr><td>Номинальное напряжение, U<sub>n</sub></td><td>800 В (макс.)</td></tr>
                    ...
                    <tr><td>Тип подключения</td><td>Винтовой (screw connection), резьба M3</td></tr>
                    <tr><td>Тип крепления</td><td>DIN-рейка NS 35/7,5 или NS 35/15</td></tr>
                    <tr><td>Габариты (Д × Ш × В)</td><td>47.7 мм × 6.2 мм × 46.9 мм</td></tr>
                    <tr><td>Материал корпуса</td><td>Полиамид (PA), термопласт</td></tr>
                    <tr><td>Максимальный рабочий ток (для 6 мм²)</td><td>41 А</td></tr>
                    <tr><td>Цвет</td><td>Жёлто-зеленый (PE)</td></tr>
                    <tr><td>Класс горючести / защита изоляции</td><td>UL 94 V-0</td></tr>
        ...
        <div class='container link-next-page'>
            ...
            <div class='prev-page-link'>
                <a href='https://encomponent.ru/products/phoenix/klemma-phoenix-contact-ut-4-bu-3044115.php'>
                    Здесь предоставлена информация о синей проходной клемме UT 4-BU артикул которой 3044115. 
                </a>
            </div>
        </div>
    </main> 
