<?php
    ...
    $article = "LC1D25M7"; // Основной артикул товара
    $pageTitle = "LC1D25M7, Электромеханический контактор - Schneider Electric";
    $ozonCardLink = "https://www.ozon.ru/product/lc1d25m7-kontaktor-schneider-electric-3234055868/";
    $SKU = "3234055868"; // Идентификатор товара на ОЗОН
         ...
         <div class='discription-product-section'>
            <div class='container'>
                ...
                <section class='main-section main-section__desktop flex'>
                    <img src='../../img/img-product/LC1D25M7/contactor-LC1D25M7.jpg' alt='Контактор Schneider Electric LC1D25M7' class='msib-img'>
                    ...
                    <div class='attention-container'>
                       ...
                       <hr class="attention-section__mobile-hr">
                        <div class='attention-section__discription'>
                            Контактор Schneider Electric LC1D25M7 из линейки TeSys D представляет собой компактный трехполюсный коммутационный аппарат, 
                            ...
                            рассчитан на работу в сетях переменного тока и обладает номинальным током 25 Ампер при эксплуатации в режиме АС-3, что позволяет 
                            эффективно управлять двигателями мощностью до 11 киловатт при стандартном напряжении 400 Вольт. При работе с чисто резистивными 
                            нагрузками по категории АС-1 прибор способен выдерживать токовую нагрузку до 40 Ампер. Управление исполнительным механизмом 
                            осуществляется посредством встроенной электромагнитной катушки, рассчитанной на номинальное напряжение 220 Вольт переменного т
                            ока с частотой 50 или 60 Герц.
                        </div>
                    </div>
                </section>
            </div>
                ...
                <div class="technical-specifications-section__table">
                    <div class="technical-specifications-list">
                        ...
                        <div class="technical-specifications-list__item">
                            ...
                            <div class="specifications-item__tech grey">25 А (AC-3)</div>
                        </div>
                        <div class="technical-specifications-list__item">
