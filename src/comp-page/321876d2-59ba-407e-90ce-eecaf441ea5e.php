...
/// Страница с описанием товара : 2866750,Источник питания QUINT-PS/1AC/24DC/ 5
...
<head>
    ...
    <meta name="description" content="Страница с описанием товара : 2866750,Источник питания QUINT-PS/1AC/24DC/ 5">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">5 А</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">120 Вт</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">130 х 40 х 125 мм</div>
                                </li>
                            </ul>
                        </div>
