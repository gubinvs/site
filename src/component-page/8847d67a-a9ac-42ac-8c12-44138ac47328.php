...
<head>
    ...
    <meta name="description" content="Выключатель автоматический двухполюсный 6А С iC60N 6кА, производитель: Schneider Electric, артикул товара производителя: A9F79206">
    <title>A9F79206, Выключатель автоматический двухполюсный 6А С iC60N 6кА</title>
...
<body>
    ...
    <main>
        <section class="discription-product-section">
            <div class="container">
                <h1 class="discription-product-section__title">A9F79206, Выключатель автоматический двухполюсный 6А С iC60N 6кА</h1>
                <div class="discription-product-section__discription-product  ">
                    <div class="discription-product-block">

                        <img class="discription-product__img" src="https://shop.encomponent.ru/img/img-product/A9F79206/A9F79206_big_1920.jpg" alt="Выключатель автоматический двухполюсный 6А С iC60N 6кА">
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">6 А</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">0.214 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                        ...
                        <div class="discription-product__bascket-block">
                            ...
                            <ul class="bascket-block-list">
                                <li class="bascket-block-item">
                                    ...
                                    <div class="bascket-block__siscr" id="vendorСode_0">A9F79206</div>
                                </li>
                                <li class="bascket-block-item">
            ...
            <div class="container">
                ...
                <div class="characteristic__discr">
                    ...
                    Автомат Acti 9 с ариткулом A9F79206 в двухполюсном исполнении. Оснащен механизмом быстрого включения, индикацией аварийного срабатывания,
