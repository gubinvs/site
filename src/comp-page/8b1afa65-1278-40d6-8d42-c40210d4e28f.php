...
/// Страница с описанием товара : 2903148, Источник питания TRIO-PS-2G/1AC/24DC/5 DIN
...
<head>
    ...
    <meta name="description" content="Страница с описанием источника питания TRIO-PS-2G/1AC/24DC/5 DIN с артикулом 2903148">
    <title>
        <?php
