...
/// Страница с описанием товара : 2866792, Источник питания QUINT-PS/3AC/24DC/20
...
<head>
    ...
    <meta name="description" content="Страница с описанием товара : 2866792, Источник питания QUINT-PS/3AC/24DC/20">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">20 А</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">480 Вт</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">0.7 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Упаковка (В х Ш х Д)</div>
                                    <div class="characteristic-type__siscr">130 х 70 х 130 мм</div>
                                </li>
                            </ul>
                        </div>
