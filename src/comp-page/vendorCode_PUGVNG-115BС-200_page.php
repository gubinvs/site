...
$article = "PUGVNG-115BС-200"; // Замените на нужный артикул
$titlePage = "PUGVNG-115BС-200, Провод ПуГВнг(A)-LS 1x1,5 мм² черный в коробке по 200 метров";
                        ...
                        <div class="characteristics-block">
                            ...
                            <ul class="characteristics-block__list">
                                ...
                                <li class="characteristics-block__item flex">
                                    ...
                                    <div class="characteristics-item__discr">черный</div>
                                </li>
                                <li class="characteristics-block__item flex">
                        ...
                        <div class="technical-specifications-section__table">
                            <ul class="technical-specifications-list">
                                ...
                                <div class="technical-specifications-list__item">
                                    ...
                                    <div class="specifications-item__tech">Черный</div>
                                </div>
                                <div class="technical-specifications-list__item">
