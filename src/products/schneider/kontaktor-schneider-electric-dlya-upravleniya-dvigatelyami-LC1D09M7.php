                ...
                <section class='attention-section'>
                    ...
                    <div class='attention-container'>
                        ...
                        <div class='attention-section__discription'>
                            <b>Контактор LC1D09M7 Schneider Electric</b> — это надёжный силовой контактор серии
                            <b>TeSys D</b>, предназначенный для управления трёхфазными электродвигателями
                            и промышленными нагрузками.

                            <br><br>
                            Контактор рассчитан на <b>номинальный ток 9 А</b> и оснащён катушкой управления
                            <b>220 В AC</b>, что делает его оптимальным решением для шкафов автоматики,
                            НКУ и распределительных щитов.

                            <br><br>
                            LC1D09M7 применяется для пуска и остановки насосов, вентиляторов,
                            компрессоров, конвейеров и другого оборудования, где требуется
                            надёжная коммутация силовых цепей переменного тока.
                        </div>
