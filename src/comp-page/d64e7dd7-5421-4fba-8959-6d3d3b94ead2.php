<?php
/// Страница с описанием товара : A9F79125, Выключатель автоматический однополюсный 25А С iC60N 6кА 
?>
<!DOCTYPE html>
<html lang="ru">
...
<head>
    ...
    <meta name="description" content="Выключатель автоматический однополюсный 25А С iC60N 6кА, производитель: Schneider Electric, артикул товара производителя: A9F79125">
    <title>A9F79125, Выключатель автоматический однополюсный 25А С iC60N 6кА</title>
...
<body>
    ...
    <main>
        <section class="discription-product-section">
            <div class="container">
                <h1 class="discription-product-section__title">A9F79125, Выключатель автоматический однополюсный 25А С iC60N 6кА</h1>
                <div class="discription-product-section__discription-product  ">
                    <div class="discription-product-block">

                        <img class="discription-product__img" src="https://shop.encomponent.ru/img/img-product/A9F79125/A9F79125_big_1920.jpg" alt="Выключатель автоматический однополюсный 25А С iC60N 6кА">
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">25 А</div>
                                </li>
                                <li class="characteristic-type-item">
                        ...
                        <div class="discription-product__bascket-block">
                            ...
                            <ul class="bascket-block-list">
                                <li class="bascket-block-item">
                                    ...
                                    <div class="bascket-block__siscr" id="vendorСode_0">A9F79125</div>
                                </li>
                                <li class="bascket-block-item">
            ...
            <div class="container">
                ...
                <div class="characteristic__discr">
                    ...
                    Автомат Acti 9 с ариткулом A9F79125 в однополюсном исполнении. Оснащен механизмом быстрого включения, индикацией аварийного срабатывания,
