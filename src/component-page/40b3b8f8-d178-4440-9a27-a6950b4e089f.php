...
/// Страница с описанием товара : XB5AVG6, SE XB5 Лампа сигнальная 22мм 48-120В синяя, Schneider Electric
...
<head>
    ...
    <meta name="description" content="Страница с описанием товара : SE XB5 Лампа сигнальная 22мм 48-120В синяя, Schneider Electric">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">Плоская (-ий)</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">110.0...120.0</div>
                                </li>
                                <li class="characteristic-type-item">
