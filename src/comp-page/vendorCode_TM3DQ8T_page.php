...
$article = "TM3DQ8T"; // Замените на нужный артикул
$titlePage = "TM3DQ8T, Дискретный модуль расширения ТМ3 8 выходов транзисторный источник, Schneider Electric";
            ...
            <div class="container">
                ...
                <section class="main-section flex">
                    <div class="main-section__img-block">
                        <img class="discription-product__img" src="../img/img-product/TM3DQ8T/TM3DQ8T_big_1920.jpg" alt=<?php echo 'Фото товара: ' . $titlePage ?> class="main-section__img">
                    </div>
                        ...
                        <div class="technical-specifications-section__table">
                            <ul class="technical-specifications-list">
                                ...
                                <div class="technical-specifications-list__item">
                                    ...
                                    <div class="specifications-item__tech grey">Транзист.</div>
                                </div>
                                <div class="technical-specifications-list__item">
                                    <div class="specifications-item__name">Возможна защита выходов от короткого замыкания</div>
                                    <div class="specifications-item__tech">1</div>
                                </div>
                                <div class="technical-specifications-list__item">
                                    <div class="specifications-item__name grey">Задержка при обмене сигналом</div>
                                    <div class="specifications-item__tech grey">0,45</div>
                                </div>
                                <div class="technical-specifications-list__item">
                                    <div class="specifications-item__name">Вес нетто, кг</div>
                                    <div class="specifications-item__tech">0.245</div>
                                </div>
                                <div class="technical-specifications-list__item">
                                ...
                                <div class="technical-specifications-list__item">
                                    <div class="equipment-section-item">
                                        <div class="discription-section-right-block__download-file flex">
                                            ...
                                            <a href="../files/TM3DQ8T/Schneider_Electric_Modicon-TM3_TM3DQ8T.pdf" class="download-file__list-link">Технические данные (PDF, 404КБ)</a>
                                        </div>
                                    </div>
                                    <div class="equipment-section-item">
                                        <div class="discription-section-right-block__download-file flex">
                                            <div class="download-file__list-icon"></div>
                                            <a href="../files/TM3DQ8T/HRB59605_09.pdf" class="download-file__list-link">Инструкция (PDF, 3,9MБ)</a>
                                        </div>
                                    </div>
                                    <div class="equipment-section-item">
                                        <div class="discription-section-right-block__download-file flex">
                                            <div class="download-file__list-icon"></div>
                                            <a href="../files/TM3DQ8T/TM3-Digital-Hardware-Guide-EN-EIO0000003125-05.pdf" class="download-file__list-link">Руководство пользователя (PDF, 8,1MБ)</a>
                                        </div>
                                    </div>
                                    <div class="equipment-section-item">
                                        <div class="discription-section-right-block__download-file flex">
                                            <div class="download-file__list-icon"></div>
                                            <a href="../files/TM3DQ8T/EcoStruxure_Automation_Expert_Catalog_English.pdf" class="download-file__list-link">Каталог (PDF, 7,6MБ)</a>
                                        </div>
                                    </div>
                                    <div class="equipment-section-item">
                                        <div class="discription-section-right-block__download-file flex">
                                            <div class="download-file__list-icon"></div>
                                            <a href="../files/TM3DQ8T/MCADID0000750_3D-CAD.zip" class="download-file__list-link">CAD файлы (ZIP, 351,KБ)</a>
                                        </div>
                                    </div>
                                    <div class="equipment-section-item">
                                        <div class="discription-section-right-block__download-file flex">
                                            <div class="download-file__list-icon"></div>
                                            <a href="../files/TM3DQ8T/ЕАЭС_KG417_026.Д.0002615_22.pdf" class="download-file__list-link">Сертификат EAЭС (PDF, 848KБ)</a>
                                        </div>
                                    </div>
                                </div>
                            </ul>
