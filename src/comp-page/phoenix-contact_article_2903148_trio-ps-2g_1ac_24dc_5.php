                ...
                <section class="advantages-section">
                    ...
                    <ul class="advantages__list">
                        <li class="advantages__item">
                            Технология SFB обеспечивает селективное срабатывание стандартных силовых выключателей, не отключая при этом параллельно подключенные потребители
                        </li>
                        <li class="advantages__item">
                            Система превентивного мониторинга сообщает о критических рабочих состояниях до появления неисправностей
                        </li>
                        <li class="advantages__item">
                            Настраиваемые в NFC пороговые значения сигнализации и характеристики максимизируют степень готовности оборудования
                        </li>
                        <li class="advantages__item">
                            Простота расширения установок благодаря статическому резерву мощности, запуск тяжелых нагрузок при помощи динамического резерва
                        </li>
                        <li class="advantages__item">
                            Высокая отказоустойчивость благодаря встроенному газоразряднику и более 20 миллисекунд времени перехода на резервный источник питания
                        </li>
                        <li class="advantages__item">
                            Прочная конструкция благодаря металлическому корпусу и расширенный диапазон температур от - 40°С до 70°C
                        </li>
                        <li class="advantages__item">
                            Возможность использования в любой страна мира благодаря широкому диапазону входных напряжений и соответствию международным стандартам
                        </li>
                    </ul>
                </section>
