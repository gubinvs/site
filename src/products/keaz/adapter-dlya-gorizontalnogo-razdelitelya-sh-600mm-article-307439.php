...
<head>
<meta charset='UTF-8'>
<title>307439, Адаптер для горизонтального разделителя Ш=600мм — купить KEAZ Optima 309982Элементы для организации секционирования OptiBox M по артикулу 307439 </title>
<meta name='description' content='Адаптер для горизонтального разделителя Ш=600мм (307439). KEAZ Optima. 309982Элементы для организации секционирования OptiBox M. Применяется для компенсации промежутка между разделителем горизонтальным и притвором внешней двери. Материал: оцинкованная сталь толщиной 1,5 мм.. Продается по цене: <?php echo $price ?> RUB.'>
<meta name='keywords' content='Адаптер для горизонтального разделителя Ш=600мм, KEAZ Optima, 307439, 309982Элементы для организации секционирования OptiBox M, купить, цена, KEAZ, электрооборудование'>
...
<link rel='canonical' href='https://encomponent.ru/products/keaz/adapter-dlya-gorizontalnogo-razdelitelya-sh-600mm-article-307439.php'>
<!--Open Graph-->
<meta property='og:title' content='Адаптер для горизонтального разделителя Ш=600мм — купить KEAZ Optima 309982Элементы для организации секционирования OptiBox M по артикулу 307439 — купить по цене <?php echo $price ?> ₽'>
<meta property='og:description' content='Адаптер для горизонтального разделителя Ш=600мм (307439). KEAZ Optima. 309982Элементы для организации секционирования OptiBox M. Применяется для компенсации промежутка между разделителем горизонтальным и притвором внешней двери. Материал: оцинкованная сталь толщиной 1,5 мм.'>
<meta property='og:image' content='System.Collections.Generic.List`1[System.String]'>
<meta property='og:type' content='product'>
<meta property='og:url' content='https://encomponent.ru/products/keaz/adapter-dlya-gorizontalnogo-razdelitelya-sh-600mm-article-307439.php'>
...
<script type='application/ld+json'>

                            {
                                ...
                                "@type": "Product",
                                "name": "Адаптер для горизонтального разделителя Ш=600мм",
                                "image": "System.Collections.Generic.List`1[System.String]",
                                "description": "Адаптер для горизонтального разделителя Ш=600мм (307439). KEAZ Optima. 309982Элементы для организации секционирования OptiBox M. Применяется для компенсации промежутка между разделителем горизонтальным и притвором внешней двери. Материал: оцинкованная сталь толщиной 1,5 мм.",
                                "sku": "307439",
                                "brand": {
                                    "@type": "Brand",
                                    "name": "KEAZ Optima"
                                ...
                                "offers": {
                                    ...
                                    "url": "https://encomponent.ru/products/keaz/adapter-dlya-gorizontalnogo-razdelitelya-sh-600mm-article-307439.php"
                                },
                                "aggregateRating": {
...
<?php include_once '../../php/modules/header.php';?>
                        ...
                        <main>
                            <div class='discription-product-section'>
                                <div class='container'>
<h1 class='discription-product-section__title NKUPages_h1'>307439, Адаптер для горизонтального разделителя Ш=600мм</h1>
                                    <section class='main-section flex'>
                                        <div class='main-section__img-block'>
<img src='https://files.keaz.ru/f/34009/307439.png' alt='Адаптер для горизонтального разделителя Ш=600мм' class='discription-product__img main-section__img'>
</div>
      
                            <div class='main-section__discription'>
                                <div class='article-block flex'>
                                    <div class='article-title'>Артикул:</div>
                                        <h6 class='article-name'>307439</h6>
                                </div>
                                <hr>
                                ...
                                <!--Количество на складе-->
                                    <div class='<?php echo $quantity > 0 ? 'warehouse-item-quantity' : 'warehouse-item-quantity warehouse-item-quantity__null' ?>'>
                                        ...
                                        <div class='characteristics-block'>
                                            <div class='characteristics-block__title'>Основные характеристики:</div>
                                                <ul class='characteristics-block__list'>
                                                    ...
                                                    <li class='characteristics-block__item flex'>
                                                        ...
                                                        <div class='characteristics-item__discr'>495</div>
                                                    </li>
                                                    <li class='characteristics-block__item flex'>
                                                        <div class='characteristics-item__title'>Ширина, мм</div>
                                                        <div class='characteristics-item__discr'>65</div>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class='characteristics-block__button-block flex'>
                                                ...
                                                <a href='https://shop.encomponent.ru/Basket/?vendorCode=307439'>
                                    ...
                                    <section class='attention-section'>
                                        ...
                                        <div class='attention-section__discription'>
                                            У нас можно купить или заказать: Адаптер для горизонтального разделителя Ш=600мм — купить KEAZ Optima 309982Элементы для организации секционирования OptiBox M по артикулу 307439 <br> Адаптер для горизонтального разделителя Ш=600мм (307439). KEAZ Optima. 309982Элементы для организации секционирования OptiBox M. Применяется для компенсации промежутка между разделителем горизонтальным и притвором внешней двери. Материал: оцинкованная сталь толщиной 1,5 мм.
                                        </div>
                                    </div>
                                </section>
...
<tr><td>Глубина</td><td>100</td></tr>
<tr><td>Ширина</td><td>600</td></tr>
<tr><td>Высота</td><td>10</td></tr>
...
<li class='files-and-documents-section__item'>3D-модели Адаптер для горизонтального разделителя Ш=600мм — <a href='https://files.keaz.ru/f/23913/307439.zip' target='_blank' rel='nofollow'><b>Скачать</b></a></li>
<li class='files-and-documents-section__item'>Каталог OptiBox M — <a href='https://files.keaz.ru/f/23823/katalog-optibox-m.pdf' target='_blank' rel='nofollow'><b>Скачать</b></a></li>
</ul>
</div>
