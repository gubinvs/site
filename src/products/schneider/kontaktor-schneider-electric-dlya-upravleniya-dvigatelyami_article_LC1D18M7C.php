...
<head>
    <meta charset='UTF-8'>
    <title>LC1D18M7C, Электромеханический контактор - Schneider Electric | Компоненты энергии</title>
    <meta name='description' content='LC1D18M7C — это электромеханический контактор (устройство для дистанционного коммутации силовых цепей), выпускаемый компанией 
    ...
    <meta name='keywords' content='LC1D18M7C — контактор Schneider Electric для управления двигателями'>
    <meta name='robots' content='index, follow'>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
    <link rel='icon' href='https://encomponent.ru/favicon.svg' type='image/svg+xml'>
    <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css' rel='stylesheet'>
    <link rel='stylesheet' href='../../css/encomp-nku-project-style.css'>
    <link rel='canonical' href='https://encomponent.ru/products/schneider/kontaktor-schneider-electric-dlya-upravleniya-dvigatelyami_article_LC1D18M7C.php'>
    <!--Open Graph-->
    <meta property='og:title' content='LC1D18M7C, Электромеханический контактор Schneider Electric продается на сайте компоненты энергии, его артикул 
        LC1D18M7C — купить можно по цене <?php echo $price ?> ₽'>
    <meta property='og:description' content='LC1D18M7C это электромеханический контактор (устройство для дистанционного коммутации силовых цепей), 
        выпускаемый компанией Schneider Electric в серии TeSys D можно купить на сайте Компоненты энергии. Продлагаем ее по цене:  <?php echo $price ?> RUB.'>
    <meta property='og:image' content='https://encomponent.ru/img/img-product/LC1D18M7/LC1D18M7_Image_1500_2.jpg'>
    <meta property='og:type' content='product'>
    <meta property='og:url' content='https://encomponent.ru/products/schneider/kontaktor-schneider-electric-dlya-upravleniya-dvigatelyami_article_LC1D18M7C.php'>
    <!-- JSON-LD Product schema -->
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "Product",
            "name": "LC1D18M7C, Электромеханический контактор - Schneider Electric",
            "image": "https://encomponent.ru/img/img-product/LC1D18M7/LC1D18M7_Image_1500_2.jpg",
            "description": "LC1D18M7C это электромеханический контактор (устройство для дистанционного коммутации силовых цепей), выпускаемый компанией Schneider Electric в серии TeSys D можно купить на сайте Компоненты энергии. Продлагаем ее по цене:  <?php echo $price ?> RUB.",
            "sku": "LC1D18M7C",
            "brand": {
                "@type": "Brand",
            ...
            "offers": {
                ...
                "url": "https://encomponent.ru/products/schneider/kontaktor-schneider-electric-dlya-upravleniya-dvigatelyami_article_LC1D18M7C.php",
                "inventoryLevel": {
...
<body>
    ...
    <main>
        <div class='discription-product-section'>
            <div class='container'>
                <h1 class='discription-product-section__title NKUPages_h1'>LC1D18M7C, Электромеханический контактор - Schneider Electric</h1>
                <section class='main-section flex'>
                    ...
                    <div class='main-section__discription'>
                        <div class='article-block flex'>
                            ...
                            <h6 class='article-name'>LC1D18M7C 
                                <a href="https://encomponent.ru/products/schneider/kontaktor-schneider-electric-dlya-upravleniya-dvigatelyami-LC1D18M7.php"> (LC1D18M7)</a> 
                            </h6>
                        </div>
                        <hr>
                        ...
                        <!--Кнопки купить в магазинах-->
                            <div class="characteristics-block__button-block flex">
                                <a href="https://www.ozon.ru/product/lc1d18m7s-kontaktor-schneider-electric-tesys-d-lc1d18m7s-18-a-katushka-240-v-ac-3501919284/" id="button-link">
                ...
                <section class='attention-section'>
                    ...
                    <div class='attention-container'>
                      ...
                      <div class='attention-section__discription'>
                            <b>Контактор LC1D18M7C Schneider Electric</b> из серии <b>TeSys D</b> предназначен
                            ...
                            <br><br>
                            Обозначение <b>«C» в конце артикула (LC1D18M7C)</b> указывает, что это версия
                            контактора, предназначенная для <b>китайского рынка</b>. Электрические характеристики
                            полностью соответствуют стандартной модели <a href="https://encomponent.ru/products/schneider/kontaktor-schneider-electric-dlya-upravleniya-dvigatelyami-LC1D18M7.php">LC1D18M7</a> , различия касаются только
                            маркировки и набора международных сертификатов.
                        </div>
                    </div>
                </section>
            </div>
