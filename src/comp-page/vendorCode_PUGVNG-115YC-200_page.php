...
$article = "PUGVNG-115YC-200"; // Замените на нужный артикул
            ...
            <div class="container">
                ...
                <section class="main-section flex">
                    <div class="main-section__img-block">
                        <img class="discription-product__img" src="../img/img-product/PUGVNG-115YC-200/PUGVNG-115YC-200_img_page.jpg" alt=<?php echo 'Фото товара: ' . $titlePage ?> class="main-section__img">
                    </div>
                        ...
                        <div class="technical-specifications-section__table">
                            <ul class="technical-specifications-list">
                                ...
                                <div class="technical-specifications-list__item">
                                    ...
                                    <div class="specifications-item__tech">Желто-зеленый</div>
                                </div>
                                <div class="technical-specifications-list__item">
