...
/// Страница с описанием товара : TM3DQ16T, Дискретный модуль расширения ТМ3- 16 выходов транзист источник
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Тип изделия</div>
                                    <div class="characteristic-type__siscr">Модуль расширения</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Количество дискретных выходов</div>
                                    <div class="characteristic-type__siscr">16</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Количество дискретных входов</div>
                                    <div class="characteristic-type__siscr">16</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Степень защиты IP</div>
                                    <div class="characteristic-type__siscr">IP20 с защитной крышкой на месте</div>
                                </li>
                                <li class="characteristic-type-item">
                        ...
                        <div class="discription-product__bascket-block">
                            ...
                            <ul class="bascket-block-list">
                                ...
                                <li class="bascket-block-item">
                                    ...
                                    <div class="bascket-block__siscr">Modicon TM3</div>
                                </li>
                            </ul>
