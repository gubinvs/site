...
/// Страница с описанием товара : 2866776,Источник питания QUINT-PS/1AC/24DC/20
...
<head>
    ...
    <meta name="description" content="Страница с описанием товара : 2866776,Источник питания QUINT-PS/1AC/24DC/20">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">2.1 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Упаковка (В х Ш х Д)</div>
                                    <div class="characteristic-type__siscr">130 х 90 х 125 мм</div>
                                </li>
                            </ul>
                        </div>
