...
<body>
    ...
    <main>
        <div class='discription-product-section'>
            <div class='container'>
                <h1 class='discription-product-section__title NKUPages_h1'>LC1D18M7 (LC1D18M7C), Электромеханический контактор - Schneider Electric</h1>
                <section class='main-section flex'>
                    ...
                    <div class='main-section__discription'>
                        <div class='article-block flex'>
                            ...
                            <h6 class='article-name'>LC1D18M7 (LC1D18M7C)</h6>
                        </div>
                        <hr>
                ...
                <section class='attention-section'>
                    ...
                    <div class='attention-container'>
                      ...
                      <div class='attention-section__discription'>
                            <b>Контактор LC1D18M7 (LC1D18M7C) Schneider Electric</b> из серии <b>TeSys D</b> предназначен
                            ...
                            полностью соответствуют стандартной модели LC1D18M7, различия касаются только
