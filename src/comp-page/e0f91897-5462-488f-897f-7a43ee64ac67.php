...
/// Страница с описанием товара : A9V41363, Блок дифференциальной защиты VIGI iC60 3P 63A 30 мA AC-ТИП
...
<head>
    ...
    <meta name="description" content=" Страница с описанием товара : A9V41363, Блок дифференциальной защиты VIGI iC60 3P 63A 30 мA AC-ТИП">
    <title>
        <?php
                        ...
                        <div class="discription-product__characteristic">
                            ...
                            <ul class="characteristic-type-list">
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">Дополнительные устройства защитного отключения</div>
                                </li>
                                <li class="characteristic-type-item">
                                ...
                                <li class="characteristic-type-item">
                                    ...
                                    <div class="characteristic-type__siscr">63 А</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Ток утечки</div>
                                    <div class="characteristic-type__siscr">30 mА</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Тип дифференциальной защиты</div>
                                    <div class="characteristic-type__siscr">АC</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Способ монтажа</div>
                                    <div class="characteristic-type__siscr">DIN-рейка</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Масса нетто</div>
                                    <div class="characteristic-type__siscr">0,21 кг.</div>
                                </li>
                                <li class="characteristic-type-item">
                                    <div class="characteristic-type__name">Упаковка (В х Ш х Д)</div>
                                    <div class="characteristic-type__siscr">95 х 120 х 74 мм</div>
                                </li>
                            </ul>
                        </div>
