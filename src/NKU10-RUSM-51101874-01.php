...
<body>
    ...
    <main>
        <div class="container">
            <h1>
                <p id="vendor-code">NKU10-RUSM-51101874-01</p>, Щит управления РУСМ5110-1874 нереверсивный 1 фидер автоматический выключатель на каждый фидер без переключателя на автоматический режим 0,6А IEK
            </h1>
            <section class="main-section flex">
                <h2 class="h1-min">NKU10-RUSM-51101874-01, Щит управления РУСМ5110-1874</h2>
                <div class="main-section__img-block">
                    <img src="img/NKU10-RUSM-51101874-01/2b9d22829f10da37d4deab10695958f61ac38cfda8b08f1060fc8295773b2dac_big.avif" alt="NKU10-RUSM-51101874-01, Щит управления РУСМ5110-1874" class="main-section__img">
                </div>
                <div class="main-section__discription">
                    <div class="article-block flex">
                        <div class="article-title">Артикул:</div>
                        <div class="article-name">NKU10-RUSM-51101874-01</div>
                    </div>
                    <hr class="hr">
                    ...
                    <div class="characteristics-block">
                        ...
                        <ul class="characteristics-block__list">
                            ...
                            <li class="characteristics-block__item flex">
                                <div class="characteristics-item__title">Степень защиты - IP</div>
                                <div class="characteristics-item__discr">IP54</div>
                            </li>
                            <li class="characteristics-block__item flex">
                                <div class="characteristics-item__title">Климатическое исполнение</div>
                                <div class="characteristics-item__discr">УХ3</div>
                            </li>
                            <li class="characteristics-block__item flex">
                                <div class="characteristics-item__title">Вид управляемого двигателя</div>
                                <div class="characteristics-item__discr">Упр. нерев. двиг.</div>
                            </li>
                            <li class="characteristics-block__item flex">
        ...
        <section class="advantages-section flex">
            ...
            <div class="advantages-section__right-block">
                <img class="advantages-section__img" style="width: 400px; height: 338px; top:170px; left:170px;" src="img/NKU10-RUSM-51101874-01/2b9d22829f10da37d4deab10695958f61ac38cfda8b08f1060fc8295773b2dac_big.avif" alt="NKU10-RUSM-51101874-01, Щит управления РУСМ5110-1874">
            </div>
        </section>
                ...
                <div class="technical-specifications-section__table">
                    <ul class="technical-specifications-list">
                        ...
                        <div class="technical-specifications-list__item">
                            ...
                            <div class="specifications-item__tech grey">УХ3</div>
                        </div>
                        <div class="technical-specifications-list__item">
                            <div class="specifications-item__name">Вид управляемого двигателя</div>
                            <div class="specifications-item__tech">Управление нереверсивными двигателями</div>
                        </div>
                        <div class="technical-specifications-list__item">
                        ...
                        <div class="technical-specifications-list__item">
                            <div class="specifications-item__name grey">Количество фидеров</div>
                            <div class="specifications-item__tech grey">Однофидерный, без переключателя на автоматический режим</div>
                        </div>
                        <div class="technical-specifications-list__item">
                            <div class="specifications-item__name">Конструктивные особенности</div>
                            <div class="specifications-item__tech">Без автоматического выключателя</div>
                        </div>
                        <div class="technical-specifications-list__item">
                            <div class="specifications-item__name grey">Ширина, мм</div>
                            <div class="specifications-item__tech grey">310</div>
                        </div>
                        <div class="technical-specifications-list__item">
                        ...
                        <div class="technical-specifications-list__item">
                            ...
                            <div class="specifications-item__tech grey">0,6</div>
                        </div>
                        <div class="technical-specifications-list__item">
                            <div class="specifications-item__name">Высота, мм</div>
                            <div class="specifications-item__tech">395</div>
                        </div>
                        <div class="technical-specifications-list__item">
                            <div class="specifications-item__name grey">Номин частота, Гц</div>
                            <div class="specifications-item__tech grey">50</div>
                        </div>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="technical-specifications-section__table mb-40">
                    <ul class="technical-specifications-list">
                        ...
                        <div class="technical-specifications-list__item">
                            <div class="equipment-section-item__article grey">BBT40-SB7-K04</div>
                            <div class="equipment-section-item__name grey">Кнопка SВ-7 "Стоп" красная 1р d22мм/240В IEK</div>
                            <div class="equipment-section-item__quantity grey">1</div>
                        </div>
                        <div class="technical-specifications-list__item">
                            <div class="equipment-section-item__article">SG-22-S</div>
                            <div class="equipment-section-item__name">Колпачок защитный IP67 AD22-S для утопленной кнопки IEK</div>
                            <div class="equipment-section-item__quantity">2</div>
                        </div>
                        <div class="technical-specifications-list__item">
                            <div class="equipment-section-item__article grey">DRT10-D004-C063</div>
                            <div class="equipment-section-item__name grey">Реле РТИ-1304 электротепловое 0,4-0,63А IEK</div>
                            <div class="equipment-section-item__quantity grey">1</div>
                        </div>
                        <div class="technical-specifications-list__item">
                ...
                <a href="files/NKU10-RUSM-51101874-01/NKU10-RUSM-51101874-01.xlsx">
                        ...
                        <div class="technical-specifications-list__item">
                            <div class="equipment-section-item">
                                <div class="discription-section-right-block__download-file flex">
                                    ...
                                    <div class="download-file__list-icon"></div>
                                    <a href="https://encomponent.ru/files/NKU10-RUSM-51101874-01/627114f8f8c602cdffab2a634d3022cf94d39bfe69cfe4d73ff38e4a1e21bf04.png" class="download-file__list-link">Схема подключения (PNG, 23,57КБ)</a>
                                </div>
                            </div>
                            <div class="equipment-section-item">
                                <div class="discription-section-right-block__download-file flex">
                            ...
                            <div class="equipment-section-item">
                                <div class="discription-section-right-block__download-file flex">
                                    <a href="https://encomponent.ru/files/NKU10-RUSM-51101874-01/8074be3de18f382c70fb3655a88188210bb32247467df2b6b56fc348ca9c7bb7.dwg">
                                        <p class="download-file__download-icon"></p>
                                    </a>
                                    <div class="download-file__list-icon"></div>
                                    <a href="https://encomponent.ru/files/NKU10-RUSM-51101874-01/8074be3de18f382c70fb3655a88188210bb32247467df2b6b56fc348ca9c7bb7.dwg" class="download-file__list-link">AutoCad, Чертеж и спецификация (DWG, 292,32КБ)</a>
                                </div>
                            </div>
                        </div>
                    </ul>
